...
\end{document}
    ...
    % Gamma and Beta Function (and properties) 
    % Expected Value and Variance (discrete & continuous case) 
    % Bivariate Data Structures  
    % Marginal Probability 
    % Correlation and Covariance
    % Mean and Variance of sample distribution
    % The Central Limit Theorem (CLT)
    
    % The Multiplication Principle
    % Binomial Coefficients formula
    % Mulinomial Coefficients formula
    % Contingency Tables
    % Tree Diagram
    % Bayes' Theorem
